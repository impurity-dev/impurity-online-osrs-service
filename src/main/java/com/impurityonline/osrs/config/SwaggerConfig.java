package com.impurityonline.osrs.config;

import com.impurityonline.osrs.OsrsApplication;
...
import static com.impurityonline.osrs.constant.Profiles.LOCAL;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage(OsrsApplication.class.getPackageName() + ".controller"))
                .build()
